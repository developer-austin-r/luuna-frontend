...
export const Modal: React.FC<ModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal Dialog */}
      <div
        className={`relative bg-white rounded-xl shadow-xl w-full border border-border-custom transform scale-100 transition-all duration-200 z-10 overflow-hidden flex flex-col max-h-[90vh] ${sizeClasses[size]}`}
      >
        {/* Header */}
